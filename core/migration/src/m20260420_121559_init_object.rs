        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(small_integer(Object::Kind).not_null())
                    .col(json_binary(Object::Data).not_null())
                    .col(integer(Object::ChunkX).not_null())
                    .col(integer(Object::ChunkY).not_null())
                    .col(small_integer(Object::X).not_null())
                    .col(small_integer(Object::Y).not_null())
